...
{
    public class PermafrostShard : ModProjectile
    {
       
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Permafrost Burst");
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int k = 0; k < Projectile.oldPos.Length; k++)
            {
                ...
                {
                    int num16 = Dust.NewDust(vector2, Projectile.width, Projectile.height, 267, 0f, 0f, 0, Color.Cyan);
        ...
        {
            return new Color(0, 255, 255, 200) * ((255f - (float)Projectile.alpha) / 255f);
        }
