...
{
    public class EnlightenedStar : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Vector2 vector69 = player.Top + new Vector2(0f, -30f);
            Projectile.Center = vector69;
            ...
            Vector2 vector163 = player.DirectionTo(player.ApplyRangeCompensation(-0.30f, center263, Main.MouseWorld)) * 10f;
            if (StardustTimer > 0)
            {
                StardustTimer--;
            ...
            if (StardustTimer == 0)
            {
                ...
                Projectile.NewProjectile(source, center263.X, center263.Y, vector163.X, vector163.Y, 260, 25, 100f, player.whoAmI);
                StardustTimer += 60;
            }
