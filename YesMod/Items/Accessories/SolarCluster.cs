...
namespace YesMod.Items.Accessories
{
    ...
    public class SolarCluster : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Solar Cluster");
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            if (ClusterTimer == 0 && player.itemAnimation > 0)
            {
                ...
                Projectile.NewProjectile(source, center.X, center.Y, vector.X, vector.Y, 645, 100, 100f, player.whoAmI);
                ClusterTimer = 100;
            }
