    ...
    public class DivineBlade : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) 
        {
            ...
            for (float num860 = 0f; num860 < 1f; num860 += 355f / (678f * (float)Math.PI))
            {
                ...
                int num861 = Projectile.NewProjectile(source , Projectile.Center, velocity, 242, damageDone / 3, 0f, Projectile.owner); //ProjectileID.242 is the High Velocity Bullet
