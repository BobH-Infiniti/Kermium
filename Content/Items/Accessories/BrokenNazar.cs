...
namespace KermiumMod.Items.Accessories    //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    ...
    public class BrokenNazar : ModItem
    {

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Broken Nazar");
            /* Tooltip.SetDefault("Significantly increases damage dealt, but getting hit petrifies you and deals more damage." +
                "\n'Tainted Hearts'"); */
