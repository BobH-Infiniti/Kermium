...
namespace KermiumMod.Items.Accessories    //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    ...
    public class TribalPendant : ModItem
    {

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Tribal Pendant");
            /* Tooltip.SetDefault("Hitting something with a projectile inflicts different debuffs depending on the damage class." +
                "\nInflicts 'On Fire' with a melee projectile." +
                "\nInflicts 'Poison' with a ranged projectile." +
                "\nInflicts 'Ichor' with a magic projectile." +
                "\nInflicts 'Frostburn' with a summon or sentry." +
