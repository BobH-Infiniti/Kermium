...
namespace KermiumMod.Items.Accessories    //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    ...
    public class AquaticJawbreaker : ModItem
    {

        public override void SetStaticDefaults()
        {
            /* DisplayName.SetDefault("Loanshark Necklace");
             Tooltip.SetDefault("Inreases armor penetration by 6" +
                "\nYou can swim and breather underwater." +
                "\nWhile submerged underwater you gain a small damage buff." +
                "\n'I can't let you take away my two best employees!'"); 
